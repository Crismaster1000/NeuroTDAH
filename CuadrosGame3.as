package {
	...
	public class CuadrosGame3 extends MovieClip {

		var cuadrantesx: Array = [0, 250, 500, 750];
		...
		var imagen1: foto1 = new foto1();
		var imagen2: foto2 = new foto2();
		var imagen3: foto3 = new foto3();
		var imagen4: foto4 = new foto4();
		var imagen5: foto5 = new foto5();
		var imagen6: foto6 = new foto6();
		var imagen7: foto7 = new foto7();
		var imagen8: foto8 = new foto8();
		var imagen9: foto9 = new foto9();
		...
		public function CuadrosGame3() {
			...
			imagenes.push(imagen1, imagen2, imagen3, imagen4, imagen5, imagen6, imagen7, imagen8, imagen9);
		...
		public function agregar_imagen(imagenes_array: Array) {
			...
			setTimeout(eliminar_cuadros, 9000, 7);
			...
			if (flag) {
				...
				if (fase > 8){
					// enviamos los datos
						...
						var datos: Array = [timer.time_execute, "3", df.format(new Date()), memoria_juegos.data.usuario.id, "3"];
